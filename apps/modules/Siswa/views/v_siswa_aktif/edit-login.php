                    ...
                    <div class="tab-content">
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Username"
                                        ...
                                        value="<?php echo $datamaster->username; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Password</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Password" name="password" id="password" aria-describedby="sizing-addon2" value="<?php echo $datamaster->password; ?>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
									...
									<?php
										if($datamaster->status_login == "aktif")
										{
									?>
...
$('#form-update').submit(function(e) {
    ...
    $.ajax({
            ...
            url: '<?php echo base_url();?>Siswa/Siswa_aktif/prosesUpdateLogin',
            type: "post",
