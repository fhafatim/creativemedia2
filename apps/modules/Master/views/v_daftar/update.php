                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Nama Lengkap"
                                        name="nama_lengkap" aria-describedby="sizing-addon2"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <select name="bidang_studi" id="bidang_studi" class="form-control selek-studi">
										...
										{										
											if($datamaster->id_bidang_studi == $datastudi->id_bidang_studi)
											{
									?>
                                        <option value="<?php echo $datastudi->id_bidang_studi; ?>" selected>
                                    ...
                                    <select name="level" id="level" class="form-control select-level">
                                        ...
                                        <?php
											foreach ($level as $datalevel) {
												if($datamaster->id_level_kelas == $datalevel->id_level_kelas)
												{
										?>
                                        <option value="<?php echo $datalevel->id_level_kelas; ?>" selected>
                                ...
                                <div class="col-sm-5">
                                    <select name="kategori_kelas" id="kategori_kelas"
										...
										foreach ($kategori_kelas as $datakategori) {
											if($datamaster->id_kategori_kelas == $datakategori->id_kategori_kelas)
											{
									?>
                                        <option value="<?php echo $datakategori->id_kategori_kelas; ?>" selected>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-5">
                                    <input type="text" class="form-control" placeholder="Harga Kursus"
                                        ...
                                        value="<?php echo $datamaster->harga_kursus ?>">
                                </div>
                            </div>
                            
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Tempat Daftar<font color="red"> *
                                    </font></label>
                                <div class="col-sm-5">
                                    <select name="tempat_daftar" id="tempat_daftar" class="form-control select-tempat-daftar">
                                        <option value="" <?php if($datamaster->tempat_daftar == ''){ echo "selected='selected'"; } ?>></option>
                                        <option value="tubanan" <?php if($datamaster->tempat_daftar == 'tubanan'){ echo "selected='selected'"; } ?>> Tubanan </option>
                                        <option value="nginden" <?php if($datamaster->tempat_daftar == 'nginden'){ echo "selected='selected'"; } ?>> Nginden </option>
                                    </select>
                                </div>
                            </div>
...
$('#form-update').submit(function(e) {
    ...
    $.ajax({
            ...
            url: '<?php echo base_url();?>Master/Daftar/prosesUpdate',
            type: "post",
