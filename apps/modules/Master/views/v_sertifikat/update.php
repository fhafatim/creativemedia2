...
<section class="content">
    ...
    <div class="box">
        <form class="form-horizontal" id="tambah_sertifikat" method="POST">
            ...
            <input type="hidden" name="id_list_sertifikat" value="<?php echo $datamaster->id_list_sertifikat; ?>">
            <div class="row">
                <div class="col-md-12">
                    <div class="box-body">
...
$('#tambah_sertifikat').submit(function(e) {
    ...
    if (error == 0) {
        $.ajax({
                ...
                url: '<?php echo site_url('Master/Sertifikat/prosesUpdate'); ?>',
                data: data,
            })
            .done(function(data) {
