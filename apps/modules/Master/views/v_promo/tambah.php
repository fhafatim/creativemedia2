<?php $this->load->view('_heading/_headerContent') ?>
        ...
        <h3 class="box-title">Tambah Data</h3>
            ...
            <label for="inputEmail3" class="col-sm-2 control-label">Judul Promo </label>
            <div class="col-sm-9">
            <input type="text" class="form-control" placeholder="judul promo" name="judul" aria-describedby="sizing-addon2">
            </div>
            </div>
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" placeholder="periode promo" name="priode_promo" aria-describedby="sizing-addon2" id="periode" >
            </div>
            </div>
			...
			<a class="klik ajaxify" href="<?php echo site_url('promo'); ?>"><button class="btn btn-primary btn-flat" ><i class="fa fa-arrow-left"></i> Kembali</button></a>
            </div>
            </form>
	...
	<script type="text/javascript">	
		...
		url:'<?php echo base_url();?>Master/Promo/prosesTambah',
		type:"post",
