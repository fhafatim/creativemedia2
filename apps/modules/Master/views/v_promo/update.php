	...
	<section class="content">
		...
		<div class="box-body">
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" placeholder="periode promo" name="priode_promo" aria-describedby="sizing-addon2" id="periode" value="<?php echo $promo->priode_promo; ?>">
            </div>
            </div>
	...
	<script type="text/javascript">	
		...
		url:'<?php echo base_url();?>Master/Promo/prosesUpdate',
		type:"post",
