<?php $this->load->view('_heading/_headerContent') ?>
        ...
        <h3 class="box-title">Tambah Data</h3>
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" placeholder="judul loker" name="judul" aria-describedby="sizing-addon2">
            </div>
            </div>
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" placeholder="gaji" name="gaji" aria-describedby="sizing-addon2">
            </div>
            </div>
	...
	<script type="text/javascript">	
		...
		url:'<?php echo base_url();?>Master/Loker/prosesTambah',
		type:"post",
