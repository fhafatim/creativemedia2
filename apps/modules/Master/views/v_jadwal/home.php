...
<section class="content">
    ...
    <div class="box">
        <div class="box-header">
            <div class="col-md-2">
                <a class="klik ajaxify" href="<?php echo site_url('add-jadwal'); ?>"><button class="btn btn-success"><i
...
<script type="text/javascript">
    ...
    table = $('#table').DataTable({ 
        ...
        "ajax": {
            "url": "<?php echo site_url('Master/Jadwal/ajax_list')?>",
            "type": "POST"
...
$(document).on("click",".hapus-jadwal",function(){
	...
	swal({
		...
		function(){
		 $.ajax({
			method: "POST",
			url: "<?php echo base_url('Master/Jadwal/hapus'); ?>",
			data: "id_kelas=" +id_kelas,
			success: function(data){
				$("tr[data-id='"+id_kelas+"']").fadeOut("fast",function(){
					$(this).remove();
				});
				hapus_berhasil();
				reload_table();
