<?php $this->load->view('_heading/_headerContent') ?>
        ...
        <h3 class="box-title">Tambah Data</h3>
            ...
            <div class="col-sm-9">
            <input type="text" class="form-control" placeholder="Nama Fasilitas" name="judul" aria-describedby="sizing-addon2">
            </div>
            </div>
		    ...
		    <option value="<?php echo $datatipe->nama; ?>">
		    <?php echo $datatipe->nama; ?>
			</option>
			<?php } ?>
			</select>
            </div>
	...
	<script type="text/javascript">	
		...
		url:'<?php echo base_url();?>Master/Fasilitas/prosesTambah',
		type:"post",
