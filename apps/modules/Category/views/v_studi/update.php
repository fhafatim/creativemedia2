	...
	<section class="content">
        ...
        <input type="hidden" name="id_bidang_studi" value="<?php echo $datastudi->id_bidang_studi; ?>">
        ...
        <div class="box-body">
         ...
         <div class="col-sm-9">
         <input type="text" class="form-control" placeholder="Bidang Studi" name="nama_bidang_studi" aria-describedby="sizing-addon2" value="<?php echo $datastudi->nama_bidang_studi; ?>">
         </div>
         </div>
        ...
        <div class="col-sm-9">
        <textarea id="summernote" name="deskripsi" rows="10" cols="80"><?php echo $datastudi->deskripsi;?>
        </textarea>
        </div>
        </div>
		...
		<div class="form-group">
		<div id="slider">
		<img class="img-thumbnail" src='../<?php echo $datastudi->gambar; ?>'>
		</div>
	...
	<script type="text/javascript">	
		...
		url:'<?php echo base_url();?>Category/Studi/prosesUpdate',
		type:"post",
