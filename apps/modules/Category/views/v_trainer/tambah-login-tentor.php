                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Username"
                                        ...
                                        value="<?php echo $datatrainer->ktp; ?>">
                                </div>
                            </div>
                            <div class="form-group">
                                <label for="inputEmail3" class="col-sm-2 control-label">Password</label>
                                <div class="col-sm-6">
                                    <input type="text" class="form-control" placeholder="Password" name="password" id="password" aria-describedby="sizing-addon2" value="<?php echo $datatrainer->nik; ?>">
                                </div>
                            </div>
...
$('#form-insert').submit(function(e) {
    ...
    $.ajax({
            ...
            url: '<?php echo base_url();?>Category/Trainer/prosesInsertLogin',
            type: "post",
