...
<section class="content">
    ...
    <div class="box">
        <form class="form-horizontal" id="tambah_bayar" method="POST">
			...
			<input type="hidden" name="id_kelas" id="id_kelas" value="<?php echo $datamaster->id_kelas ?>"/>
			<input type="hidden" name="id_honor" id="id_honor" value="<?php echo $datamaster->id_honor ?>"/>
            <div class="row">
                <div class="col-md-12">
                    <div class="box-body">
                        <div class="form-group">
                            ...
                            <div class="col-sm-4">
                                <select name="pendaftaran_kursus" id="pendaftaran_kursus"
                                    class="form-control select-pendaftaran-kursus" disabled>

                                    <?php
										foreach ($kursus as $datakursus) {
									?>
										
											<option value="<?php echo $datakursus->id_kelas ; ?>" <?php if($datakursus->id_kelas == $datamaster->id_kelas ){  echo "selected='selected'";  }?>>
												<?php echo $datakursus->no_pendaftaran.' - '.$datakursus->nama_tentor.' - '.$datakursus->nama_siswa ?>
											</option>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-3">
                                <input type="text" class="form-control" placeholder="Jumlah Honor" name="jumlah_honor"
                                    id="jumlah_honor" aria-describedby="sizing-addon2" value="<?php echo $datamaster->nominal ?>" disabled>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-2">
                            <input type="text" class="form-control" placeholder="Tanggal Pembayaran" autocomplete="off"
                                name="tanggal_pembayaran" id="tanggal_pembayaran" aria-describedby="sizing-addon2" value="<?php echo $datamaster->tanggal_pembayaran ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" placeholder="Jumlah Pembayaran" name="nominal"
                                id="nominal" aria-describedby="sizing-addon2" autocomplete="off" value="<?php echo $datamaster->jumlah_pembayaran ?>">
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <select name="kategori_pembayaran" id="kategori_pembayaran" class="form-control select-kategori-invoice">
                                <option></option>
								<?php
									if($datamaster->kategori_pembayaran == "setengah")
									{
								?>
										<option value="setengah" selected> Setengah </option>
...
$('#tambah_bayar').submit(function(e) {
    ...
    if (error == 0) {
        $.ajax({
                ...
                url: '<?php echo site_url('Category/Honor/prosesUpdate'); ?>',
                data: data,
            })
            .done(function(data) {
                var result = jQuery.parseJSON(data);
