PATH = window.location.protocol + "//" + window.location.host + "/angular3";
...
angular.module('admin', ['ui.bootstrap', 'ngGrid', 'jQuery-ui']).
  config(function($routeProvider) {
    $routeProvider.      		
		when('/schema', { templateUrl:BASE_URL+'admin/schema'}).
