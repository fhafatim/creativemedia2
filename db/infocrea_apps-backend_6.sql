...
--
-- Host: 127.0.0.1
-- Generation Time: Sep 15, 2021 at 10:05 AM
...
(1, 'superadmin', '17c4520f6cfd1ab53d8745e84681eb49', 'admincreative@gmail.com', 'Admin Creative Media', 1, 'no-image.jpg', 3, '0000-00-00 00:00:00', '2019-05-07 10:22:32', '', 'Admin Creative Media', '2021-09-15 11:14:13'),
...
CREATE TABLE `tbl_level_kelas` (
  ...
  `nama_level_kelas` enum('kosong','basic','advanced','') NOT NULL,
  `created_date` datetime NOT NULL,
  `updated_date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(3, 'kosong', '2021-09-15 10:04:20', '2021-09-15 10:04:20');
...
(1, 'CM212', '2021-09-02', 1, 2, 2, 2, '200005', 'selesai', '2021-09-02 15:24:32', '2021-09-08 15:17:50'),
...
(9, 'CM215', '2021-09-13', 10, 2, 1, 1, '10000', 'batal', '2021-09-13 12:48:02', '2021-09-13 12:48:02');
