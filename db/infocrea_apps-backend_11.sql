...
(1, 'superadmin', '17c4520f6cfd1ab53d8745e84681eb49', 'admincreative@gmail.com', 'Admin Creative Media', 1, 'no-image.jpg', 3, '0000-00-00 00:00:00', '2019-05-07 10:22:32', '', 'Admin Creative Media', '2021-10-18 08:18:41'),
...
INSERT INTO `tbl_pendaftaran` (`id_pendaftaran`, `no_pendaftaran`, `tanggal_pendaftaran`, `id_siswa`, `id_bidang_studi`, `id_kategori_kelas`, `id_level_kelas`, `metode_belajar`, `harga_kursus`, `status_pendaftaran`, `created_date`, `updated_date`) VALUES
...
--
ALTER TABLE `tbl_bidang_studi`
  MODIFY `id_bidang_studi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=16;
