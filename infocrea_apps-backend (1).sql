...
--
-- Host: 127.0.0.1
-- Generation Time: Mar 30, 2022 at 08:51 AM
...
(1, 'superadmin', '17c4520f6cfd1ab53d8745e84681eb49', 'admincreative@gmail.com', 'Admin Creative Media', 1, 'no-image.jpg', 3, '0000-00-00 00:00:00', '2019-05-07 10:22:32', '', 'Admin Creative Media', '2022-03-30 13:45:05'),
...
(6, 'masterhrd', '459bc1727780021448dfc54438f5b8a5', 'hrd@creativemedia.id', 'HRD Creative Media', 5, 'no-image.jpg', 3, '2019-05-07 14:07:25', '2022-03-19 19:57:19', 'Admin Creative Media', 'Admin Creative Media', '2022-03-30 13:38:48');
...
INSERT INTO `cuti` (`no_surat`, `nama`, `jabatan`, `divisi`, `tglcuti`, `selesai`, `jeniscuti`, `sisacuti`, `keperluan`, `lampiran`, `status`) VALUES
('SIC-0001', 'Fatim', 'HRD', 'HRD', '2021-12-09 00:00:00', '0000-00-00 00:00:00', 'tahunan', 10, 'acara keluarga', '', 'approved'),
('SIC-0002', 'Admin Creative Media', 'add', 'dd', '2022-03-29', '2022-03-31', 'Tahunan', 0, 'asca', 'upload/lampiran/avatar.png', '');
...
--
-- Table structure for table `fasilitas_tipe`
--
...
--
-- Dumping data for table `fasilitas_tipe`
--
...
INSERT INTO `import` (`no_pendaftaran`, `nama`) VALUES
('c1', 'cac1'),
('c2', 'cac2'),
('c3', 'cac3');
...
(2, 'CM211', '', '', 'laki-laki', '08989230204', 'muhnailul@gmail.com', 'surabaya', '', 'nailul abrori', 'Desain Arsitektur', 'Class Privat', 'Reguler', '2000000', '2000000', '0', 'Lunas', 'Calon Siswa', 'Admin Creative Media', '2021-08-09 14:30:27', '2021-08-09', '');
...
INSERT INTO `tbl_bank` (`id_bank`, `name`, `code`) VALUES
(1, 'BANK BRI', '002'),
...
--
-- Table structure for table `tbl_bidang_studi`
--
...
--
-- Dumping data for table `tbl_bidang_studi`
--

INSERT INTO `tbl_bidang_studi` (`id_bidang_studi`, `nama_bidang_studi`, `deskripsi`, `gambar`, `created_date`, `updated_date`) VALUES
...
(13, 'Animasi', '', '', '2021-09-17 10:06:46', '2021-09-17 10:06:46'),
(14, 'Pemrograman Dasar', '', '', '2021-09-17 10:06:46', '2021-09-17 10:06:46'),
(15, 'Photography', '', '', '2021-09-17 10:06:46', '2021-09-17 10:06:46'),
(16, 'Lainnya', 'Bidang studi custom', '', '2021-10-19 12:17:13', '2021-10-19 12:17:13');
...
(1, 1, 'CM211', 'Pak Dicky', 'Angel Yuliana Sabina Tena Uak S.Ilkom', 'Komputer Umum & Internet', '1970-01-01', '300000', '2021-10-01', 'tunai', '150000', '', '', '', 'setengah', 'tubanan', '2021-10-13 21:30:56', '2021-10-13 21:30:56'),
(2, 1, 'CM211', 'Pak Dicky', 'Angel Yuliana Sabina Tena Uak S.Ilkom', 'Komputer Umum & Internet', '1970-01-01', '300000', '2021-10-18', 'tunai', '150000', '', '', '', 'semua', 'tubanan', '2021-10-13 21:52:52', '2021-10-13 21:52:52'),
(4, 2, 'CM212', 'Pak Richard', 'Yusron Nugroho Aji', 'Administrasi Perkantoran', '1970-01-01', '600000', '2021-10-27', 'tunai', '300000', '', '', '', 'setengah', 'tubanan', '2021-10-14 08:22:48', '2021-10-14 08:22:48');
...
(1, 'INV10211', 1, '2021-10-13', 'lunas', '2021-10-13 16:06:35', '2021-10-13 16:06:35'),
(2, 'INV10212', 2, '2021-10-13', 'lunas', '2021-10-13 18:00:09', '2021-10-13 18:00:09'),
(3, 'INV10213', 3, '2021-10-18', 'pending', '2021-10-18 08:44:27', '2021-10-18 08:44:27'),
(4, 'INV10214', 4, '2021-10-18', 'pending', '2021-10-18 08:50:10', '2021-10-18 08:50:10'),
(5, 'INV10215', 5, '2021-10-18', 'pending', '2021-10-18 08:52:27', '2021-10-18 08:52:27'),
(6, 'INV10216', 6, '2021-10-18', 'pending', '2021-10-18 16:05:11', '2021-10-18 16:05:11'),
(7, 'INV10217', 7, '2021-10-18', 'pending', '2021-10-18 16:07:24', '2021-10-18 16:07:24'),
(8, 'INV10218', 8, '2021-10-19', 'pending', '2021-10-19 12:14:45', '2021-10-19 12:14:45'),
(9, 'INV10219', 9, '2021-10-19', 'pending', '2021-10-19 12:29:23', '2021-10-19 12:29:23'),
(10, 'INV102110', 10, '2021-10-19', 'pending', '2021-10-19 12:38:42', '2021-10-19 12:38:42');
...
CREATE TABLE `tbl_karyawan` (
  ...
  `jabatan` enum('cso','admin','manager','programmer') NOT NULL,
...
INSERT INTO `tbl_karyawan` (`id_karyawan`, `nama_karyawan`, `nik`, `jenis_kelamin`, `tanggal_lahir`, `tempat_lahir`, `alamat`, `kota`, `provinsi`, `telepon`, `telepon_alternatif`, `pendidikan`, `lembaga_pendidikan`, `tahun_lulus`, `jabatan`, `tanggal_masuk`, `gambar`, `status_karyawan`, `created_date`, `updated_date`) VALUES
(1, 'Agung Wahyu', '53091849819481', 'laki-laki', '1999-09-23', 'Jember', 'Umbulsari Jember', 'Jember', 'Jawa Timur', '08127361', '08172672167', 'D4', 'Politeknik Negeri Jember', '2021', 'programmer', '2021-09-01', 'upload/karyawan/karyawan.jpg', 'aktif', '2021-09-23 05:04:48', '2021-09-23 05:04:48'),
(2, 'Pak Nailul', '2471287812', 'laki-laki', '1998-09-23', 'Jember', 'Jember', 'Jember', 'Jawa Timur', '08127362176', '092818214826', 'D3', 'Polije', '2012', 'manager', '2021-07-01', 'upload/gambar/karyawan.jpg', 'aktif', '2021-09-23 11:15:30', '2021-09-23 11:15:30'),
(3, 'dasda', '312341', 'laki-laki', '2022-03-09', 'prob', 'dsas', 'ksnlkd', 'nsda', '312391', '32103', 'SMP', 'asdlnas', '2022', '', '2022-03-09', 'upload/karyawan/avatar.png', 'aktif', '2022-03-19 23:36:06', '2022-03-19 23:36:06');
...
(1, 'Inspirasi Class', '2021-08-16 03:39:55', '2021-08-16 03:39:55'),
(2, 'Mandiri Class', '2021-08-16 03:39:55', '2021-08-16 03:39:55'),
(3, 'Reguler Class', '2021-10-18 03:25:55', '2021-10-18 03:25:55');
...
CREATE TABLE `tbl_kelas` (
  ...
  `created_date` datetime NOT NULL,
  `updated_date` datetime NOT NULL,
  `ruang` enum('tubanan','nginden','home') NOT NULL,
  `status_honor` enum('pending','lunas') NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_kelas` (`id_kelas`, `id_pendaftaran`, `id_siswa`, `id_tentor`, `jumlah_pertemuan`, `tanggal_mulai`, `tanggal_selesai`, `status_kelas`, `created_date`, `updated_date`, `ruang`, `status_honor`) VALUES
(1, 1, 1, 1, 10, '2021-10-04', '1970-01-01', 'selesai', '2021-10-13 17:10:25', '2021-10-13 21:52:52', 'tubanan', 'lunas'),
(2, 2, 2, 2, 10, '2021-10-18', '1970-01-01', 'berjalan', '2021-10-13 18:12:41', '2021-10-13 18:00:00', 'tubanan', 'pending');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_level_kelas`
--

CREATE TABLE `tbl_level_kelas` (
  `id_level_kelas` int(11) NOT NULL,
  `nama_level_kelas` enum('-','basic','advanced','') NOT NULL,
  `created_date` datetime NOT NULL,
  `updated_date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

--
-- Dumping data for table `tbl_level_kelas`
--
...
(3, '-', '2021-09-15 10:04:20', '2021-09-15 10:04:20');

-- --------------------------------------------------------

--
-- Table structure for table `tbl_list_sertifikat`
--

CREATE TABLE `tbl_list_sertifikat` (
  `id_list_sertifikat` int(11) NOT NULL,
  `id_kelas` int(11) NOT NULL,
  `tanggal` date NOT NULL,
  `nama_siswa` varchar(100) NOT NULL,
  `nama_bidang_studi` varchar(200) NOT NULL,
...
--
-- Dumping data for table `tbl_list_sertifikat`
--

INSERT INTO `tbl_list_sertifikat` (`id_list_sertifikat`, `id_kelas`, `tanggal`, `nama_siswa`, `nama_bidang_studi`, `status`, `created_date`, `updated_date`) VALUES
(1, 1, '2021-10-18', 'Angel Yuliana Sabina Tena Uak S.Ilkom', 'Komputer Umum & Internet', 'pending', '2021-10-18', '2021-10-18');
...
(1, 'siswa', 'CM211a', 'CM211a', 'aktif', '2021-10-11 14:54:43', '2021-10-11 14:54:43'),
(2, 'siswa', 'tes@gmail.com', '24d9020262847faf98bd6c3c4107daf7', 'belum aktif', '2021-10-18 08:44:27', '2021-10-18 08:44:27'),
(4, 'siswa', 'coba@coba.com', 'bcf782c5cd6a773bbe7d499c257d69ff', 'belum aktif', '2021-10-18 16:05:11', '2021-10-18 16:05:11'),
(5, 'siswa', 'coba2@coba.com', 'be1335ce03a87650eeeebab9d62b943c', 'belum aktif', '2021-10-18 16:07:24', '2021-10-18 16:07:24'),
(6, 'siswa', 'coba3@coba.com', '786460b284b836a2bb3c0e3c4e70f4da', 'belum aktif', '2021-10-19 12:14:45', '2021-10-19 12:14:45'),
(7, 'siswa', 'coba4@coba.com', 'a7cb2d70394bcf4864ba8b7f2c3085ad', 'belum aktif', '2021-10-19 12:29:23', '2021-10-19 12:29:23'),
(8, 'siswa', 'coba5@coba.com', '1a565209388fbc9475b580d62c93e76b', 'belum aktif', '2021-10-19 12:38:42', '2021-10-19 12:38:42');
...
(2, 'Setting', '', 'fa fa-wrench', 0, 'setting', 'view', 14, '2018-04-20 09:19:49', '2021-10-13 16:37:10', '', 'Admin Creative Media'),
...
(35, 'Kategori', '', 'fa  fa-list', 0, 'list-kategori', 'view', 6, '2018-11-06 08:45:59', '2021-10-13 16:33:11', 'Admin web master', 'Admin Creative Media'),
...
(38, 'Master Siswa', '', 'fa fa-user', 0, 'master-data', 'view', 4, '2018-12-06 04:11:04', '2021-10-13 16:32:20', 'Admin Creative Media', 'Admin Creative Media'),
...
(41, 'Master Fasilitas', 'fasilitas', 'fa fa-bank', 0, 'fasilitas', 'view,add,edit,del', 10, '2018-11-28 10:30:22', '2021-10-13 16:35:01', 'Admin Creative Media', 'Admin Creative Media'),
(42, 'Master Galeri', 'galeri', 'fa fa-file-image-o', 0, 'galeri', 'view,add,edit,del', 11, '2018-11-29 09:27:15', '2021-10-13 16:35:25', 'Admin Creative Media', 'Admin Creative Media'),
(43, 'Master Promo', 'promo', 'fa fa-gift', 0, 'promo', 'view,add,edit,del', 12, '2018-11-29 12:05:27', '2021-10-13 16:35:44', 'Admin Creative Media', 'Admin Creative Media'),
(44, 'Master Loker', 'loker', 'fa fa-briefcase', 0, 'loker', 'view,add,edit,del', 13, '2018-12-01 03:34:30', '2021-10-13 16:36:04', 'Admin Creative Media', 'Admin Creative Media'),
(45, 'Trainer', 'trainer', 'fa fa-users', 58, 'trainer', 'view,add,edit,del', 1, '2018-12-03 04:48:27', '2021-09-24 11:28:22', 'Admin Creative Media', 'Admin Creative Media'),
(46, 'Pendaftaran', 'daftar', 'fa fa-user-plus', 0, 'daftar', 'view,add,edit,del', 1, '2018-11-06 13:10:07', '2021-10-13 16:30:53', 'Admin Creative Media', 'Admin Creative Media'),
...
(50, 'Master Penjadwalan', '', 'fa fa-calendar', 0, 'master-jadwal', 'view', 3, '2018-12-10 08:10:23', '2021-10-13 16:31:48', 'Admin Creative Media', 'Admin Creative Media'),
...
(53, 'Master Report', '', 'fa fa-book', 0, 'master-report', 'view', 7, '2018-12-12 07:53:56', '2021-10-13 16:36:46', 'Admin Creative Media', 'Admin Creative Media'),
...
(55, 'Master Artikel', 'artikel', 'fa fa-newspaper-o', 0, 'artikel', 'view,add,edit,del', 8, '2018-12-27 02:38:12', '2021-10-13 16:34:08', 'Admin Creative Media', 'Admin Creative Media'),
(56, 'Pembayaran', 'pembayaran', 'fa fa-money', 0, 'pembayaran', 'view,add,edit,del', 2, '2021-08-20 14:28:00', '2021-10-13 16:31:22', 'Admin Creative Media', 'Admin Creative Media'),
(57, 'Master Karyawan', 'karyawan', 'fa fa-user-secret', 0, 'karyawan', 'view,add,edit,del', 7, '2021-09-23 09:54:45', '2021-10-13 16:33:45', 'Admin Creative Media', 'Admin Creative Media'),
(58, 'Master trainer', '', 'fa fa-users', 0, 'master-trainer', 'view', 5, '2021-09-24 11:27:54', '2021-10-13 16:32:48', 'Admin Creative Media', 'Admin Creative Media'),
(59, 'Honor', 'honor', 'fa fa-money', 58, 'honor', 'view,add,edit,del', 1, '2021-09-24 11:30:13', '0000-00-00 00:00:00', 'Admin Creative Media', ''),
(60, 'Report Tagihan', 'report-tagihan', 'fa fa-circle-o', 53, 'report-tagihan', 'view,add,edit,del', 3, '2021-10-13 19:13:53', '2021-10-13 20:17:33', 'Admin Creative Media', 'Admin Creative Media'),
(61, 'Report Pembayaran', 'report-pembayaran', 'fa fa-circle-o', 53, 'report-pembayaran', 'view,add,edit,del', 4, '2021-10-13 20:26:11', '0000-00-00 00:00:00', 'Admin Creative Media', ''),
(62, 'Report Honor', 'report-honor', 'fa fa-circle-o', 53, 'report-honor', 'view,add,edit,del', 5, '2021-10-13 20:51:53', '0000-00-00 00:00:00', 'Admin Creative Media', ''),
(63, 'List Sertifikat', 'sertifikat', 'fa fa-circle-o', 38, 'sertifikat', 'view,add,edit,del', 3, '2021-10-18 09:36:29', '0000-00-00 00:00:00', 'Admin Creative Media', ''),
(65, 'Cuti', 'cuti', 'fa fa-calendar-check-o', 0, 'cuti', 'view,add,edit,del', 5, '2022-02-18 03:12:01', '2022-02-18 03:49:16', 'Admin Creative Media', 'Admin Creative Media');
...
CREATE TABLE `tbl_pembayaran` (
  ...
  `status_pembayaran` enum('diterima','lunas','batal','pending') NOT NULL,
  `kategori_pembayaran` enum('uang muka','cicilan','pelunasan','') NOT NULL,
  `tempat_pembayaran` varchar(255) NOT NULL,
  `created_date` datetime NOT NULL,
  `updated_date` datetime NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_pembayaran` (`id_pembayaran`, `kode_pembayaran`, `id_invoice`, `sisa_tagihan`, `tanggal_pembayaran`, `jenis_pembayaran`, `bank`, `nomor_rekening`, `atas_nama`, `nominal`, `status_pembayaran`, `kategori_pembayaran`, `tempat_pembayaran`, `created_date`, `updated_date`) VALUES
(1, 'BYR10211', 1, 3000000, '2021-10-01', 'tunai', NULL, NULL, NULL, '2000000', 'diterima', 'uang muka', 'tubanan', '2021-10-13 16:17:33', '2021-10-13 16:17:33'),
(3, 'BYR10212', 1, 1000000, '2021-10-31', 'tunai', NULL, NULL, NULL, '1000000', 'diterima', 'pelunasan', 'tubanan', '2021-10-13 17:29:44', '2021-10-13 17:29:44'),
(4, 'BYR10213', 2, 2000000, '2021-10-11', 'tunai', NULL, NULL, NULL, '1000000', 'diterima', 'uang muka', 'tubanan', '2021-10-13 18:11:59', '2021-10-13 18:11:59'),
(5, 'BYR10214', 2, 1000000, '2021-10-01', 'tunai', NULL, NULL, NULL, '1000000', 'diterima', 'pelunasan', 'tubanan', '2021-10-15 16:58:34', '2021-10-15 16:58:34');
...
CREATE TABLE `tbl_pendaftaran` (
  ...
  `id_kategori_kelas` int(11) NOT NULL,
  `id_level_kelas` int(11) NOT NULL,
  `metode_belajar` varchar(100) NOT NULL,
  `harga_kursus` varchar(100) NOT NULL,
...
INSERT INTO `tbl_pendaftaran` (`id_pendaftaran`, `no_pendaftaran`, `tanggal_pendaftaran`, `id_siswa`, `id_bidang_studi`, `keterangan`, `id_kategori_kelas`, `id_level_kelas`, `metode_belajar`, `harga_kursus`, `status_pendaftaran`, `created_date`, `updated_date`) VALUES
(1, 'CM211', '2021-10-13', 1, 1, '', 1, 3, '', '3000000', 'selesai', '2021-10-13 16:06:34', '2021-10-13 16:06:34'),
(2, 'CM212', '2021-10-13', 2, 3, '', 1, 3, '', '2000000', 'selesai', '2021-10-13 18:00:09', '2021-10-13 18:00:09'),
(3, 'CM213', '2021-10-18', 23, 1, '', 1, 1, 'private class', '3000000', 'pending', '2021-10-18 08:44:27', '2021-10-18 08:44:27'),
(4, 'CM214', '2021-10-18', 3, 2, '', 2, 1, '', '2000000', 'batal', '2021-10-18 08:50:10', '2021-10-18 08:50:10'),
(5, 'CM215', '2021-10-18', 4, 4, '', 2, 1, 'home class', '2000000', 'pending', '2021-10-18 08:52:27', '2021-10-18 08:52:27'),
(6, 'CM216', '2021-10-18', 25, 1, '', 1, 1, 'private class', '1000000', 'pending', '2021-10-18 16:05:11', '2021-10-18 16:05:11'),
(7, 'CM217', '2021-10-18', 26, 1, '', 1, 1, 'private class', '1000000', 'pending', '2021-10-18 16:07:24', '2021-10-18 16:07:24'),
(8, 'CM218', '2021-10-19', 27, 1, 'IoT', 2, 1, 'private class', '1000000', 'pending', '2021-10-19 12:14:45', '2021-10-19 12:14:45'),
(9, 'CM219', '2021-10-19', 28, 16, 'Data science', 1, 1, 'private class', '1000000', 'pending', '2021-10-19 12:29:23', '2021-10-19 12:29:23'),
(10, 'CM2110', '2021-10-19', 29, 1, '1', 1, 1, 'private class', '2000000', 'pending', '2021-10-19 12:38:42', '2021-10-19 12:38:42');
...
CREATE TABLE `tbl_siswa` (
  ...
  `status_saat_ini` varchar(100) NOT NULL,
  `upload_ktp` varchar(500) NOT NULL,
  `upload_kk` varchar(500) NOT NULL,
  `cap_waktu` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
INSERT INTO `tbl_siswa` (`id_siswa`, `id_login`, `nis`, `nama_siswa`, `jenis_kelamin`, `nik`, `tempat_lahir`, `tanggal_lahir`, `agama`, `jenis_tinggal`, `telepon`, `email`, `alamat`, `provinsi`, `kota`, `kode_pos`, `warga_negara`, `pendidikan_terakhir`, `nama_ayah`, `nama_ibu`, `alamat_ayah`, `alamat_ibu`, `nik_ayah`, `nik_ibu`, `pekerjaan_ayah`, `pekerjaan_ibu`, `pendidikan_ayah`, `pendidikan_ibu`, `tempat_lahir_ayah`, `tempat_lahir_ibu`, `tanggal_lahir_ayah`, `tanggal_lahir_ibu`, `penghasilan_ayah`, `penghasilan_ibu`, `telepon_ayah`, `telepon_ibu`, `email_ayah`, `email_ibu`, `gambar`, `created_date`, `updated_date`, `status_siswa`, `no_telepon`, `status_saat_ini`, `upload_ktp`, `upload_kk`, `cap_waktu`) VALUES
(1, 0, 'CM211', 'Angel Yuliana Sabina Tena Uak S.Ilkom', 'Perempuan', '3578306007970000', 'Kewapante', '1997-07-20', 'Katolik', 'Bersama Orang Tua', '89514578294', '', 'Pondok Benowo Indah blok DP-05', '', '', '', '', 'S1', 'Bernadinus Laba', 'Administrasi Perkantoran', '', 'Rosiana Gertudis M', '3578301905690010', '3578306503670000', 'Karyawan swasta', 'Ibu rumah tangga', '', '', 'Lewokukung', 'Pajorejo', '1969-05-19', '1967-04-25', '2 Juta - 5 Juta', '< 2 Juta', '81290640244', '81231330661', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '81234626004', 'Belum Kerja', 'https://drive.google.com/u/0/open?usp=forms_web&id=1R7zM6kFy-cN0J03wAzr7FD1fmk7AL4wI', 'https://drive.google.com/u/0/open?usp=forms_web&id=1SR5JMsj7XKNm3XFmqSdtgBnX8kxpT2p_', '2021/07/08 8:54:24 AM GMT+7'),
(2, 0, 'CM211', 'Yusron Nugroho Aji', 'Laki-Laki', '3504162108010000', 'Tulungagung', '2001-08-21', 'Islam', 'Bersama Orang Tua', '81334068368', '', 'Ds Pelen Kec.Campurdarat', '', '', '', '', 'SMA/Sederajat', 'Hari Winarno', 'Pemrograman Web', '', 'Suharlin', '3504160606730000', '3504165109730000', 'PNS', 'PNS', '', '', 'Tulungagung', 'Tulungagung', '1973-06-06', '1973-09-11', '2 Juta - 5 Juta', '2 Juta - 5 Juta', '+62 821-3153-9477', '81335893189', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '81334068368', 'Mahasiswa', 'https://drive.google.com/u/0/open?usp=forms_web&id=17O3E78UkrmYR97V7b6J7_Mqfd27RNe9v', 'https://drive.google.com/u/0/open?usp=forms_web&id=1D1XFRTloCb4UFT2fd0jylHVFCfOI6iVp', '2021/07/11 7:24:27 PM GMT+7'),
(3, 0, 'CM211', 'Wahyu Jati Wisesa', 'Laki-Laki', '9104011907020000', 'Nabire', '2002-07-19', 'Islam', 'Bersama Saudara', '87863272799', '', 'Kemlaten 7/22', '', '', '', '', 'SMA/Sederajat', 'Radi Sudarsono', 'Web Designer', '', 'Iriana Ana Lebang', '9104012206640000', '9104016707720000', 'PNS', 'PNS', '', '', 'Sidoarjo', 'Tana Toraja', '1964-06-22', '1972-07-27', '6 Juta - 10 Juta', '2 Juta - 5 Juta', '85244998030', '81372504446', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '87863272799', 'Mahasiswa', 'https://drive.google.com/u/0/open?usp=forms_web&id=1yeue5mD6jtnpVm-LnTd5Ny4h48Cn1p0m', 'https://drive.google.com/u/0/open?usp=forms_web&id=1VW3IqnLJMjHStYTUrgodjQlrLm5aIwjS', '2021/07/13 11:27:01 AM GMT+7'),
(4, 0, 'CM211', 'Helena Setiasari', 'Perempuan', 'B9985605', 'Surabaya', '2001-05-03', 'Katolik', 'Asrama', '6281252420936', 'helena_setiasari@yahoo.com', 'Sun-U Residence, Bandar Sunway, Selangor, Malaysia', '', '', '', '', 'SMA/Sederajat', 'Heppy Sugeng', 'Komputer Akuntansi', 'Basic', 'Henny Supiah', '', '', '', '', '', '', '', '', '2021-10-12', '2021-10-12', '', '', '8123538610', '81252420963', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '', 'Mahasiswa', 'https://drive.google.com/u/0/open?usp=forms_web&id=1eVTTfoRZK9QSGkG0pRlEdJYXOggYZIVP', 'https://drive.google.com/u/0/open?usp=forms_web&id=1YwibLKYwXDbWFalbW8NPjOC173gyjZ1X', '2021/08/02 3:46:50 PM GMT+7'),
(5, 0, 'CM211', 'Margie A. Samuel', 'Perempuan', '7171056501020000', 'Manado', '2002-01-25', 'Kristen', 'Kost-Kostan', '82292604102', '', 'Singapore', '', '', '', '', 'SMA/Sederajat', '', 'Desain Interior', '', '', '', '', '', '', '', '', '', '', '2021-10-12', '2021-10-12', '', '', '', '', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '82292604102', 'Mahasiswa', 'https://drive.google.com/u/0/open?usp=forms_web&id=1S0RAftLtMHshB1mC8IXOPexfT3G9Dp06', '', '2021/08/12 2:03:13 PM GMT+7'),
(6, 0, 'CM211', 'Ahmad Sa\'ad Budiman', 'Laki-Laki', '3522232703000000', 'Bojonegoro', '2000-03-27', 'Islam', 'Bersama Orang Tua', '85330030884', 'saadbudiman27@gmail.com', 'Desa Padang Rt 08/ Rw 01 Kec.Trucuk Kab.Bojonegoro', '', '', '', '', 'SMA/Sederajat', 'Budiono', 'Pemrograman Web', 'Basic', 'Siti Aminah', '352223170667003', '352223560467001', 'Wiraswasta', 'Wiraswasta', '', '', 'Bojonegoro', 'Bojonegoro ', '1967-06-17', '1967-04-16', '> 10 Juta', '> 10 Juta', '85330030884', '81332667855', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '', 'Mahasiswa', 'https://drive.google.com/u/0/open?usp=forms_web&id=1P67TsJVkZk5BP9m5NMYko99JDL61fgUT', 'https://drive.google.com/u/0/open?usp=forms_web&id=1__g_nVVOwE6tvBjNL5RPr6LwxvEmRV3n', '2021/08/15 10:31:45 PM GMT+7'),
(7, 0, 'CM211', 'Amanda Prasista', 'Perempuan', '3578145510020000', 'Surabaya', '2002-10-15', 'Islam', '', '82143239535', 'amandasista1510@gmail.com', 'Jalan Manukan Karya A1/50', '', '', '', '', 'SMA/Sederajat', 'ALM.Ir Lukman hidayat', 'Administrasi Perkantoran', 'Basic', 'Nurul Widyawati, SE', '', '', '', '', '', '', '', '', '2021-10-12', '2021-10-12', '', '', 'Tidak ada', '85100618948', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '82143239535', 'Mahasiswa', 'https://drive.google.com/u/0/open?usp=forms_web&id=1YZPLLTfJcYLNldePBZX8Jr7GHI2dkCEQ', '', '2021/08/16 4:08:31 PM GMT+7'),
(8, 0, 'CM211', 'Agustina Carolina', 'Perempuan', '5307055806960000', 'Maumere Nusa Tenggara Timur ', '1997-06-18', 'Katolik', 'Kost-Kostan', '82189800550', 'Linacarolina@gmail.com ', 'Jl.Moan Subuh Sadipun', '', '', '', '', 'SMA/Sederajat', 'Everius Elias Nong Seli', 'Editing Video Multimedia', 'Basic', 'Adriana Indrawati Mbu', '5307051003720000', '5307054909790000', 'Sopir', 'IRT', '', '', 'Nele', 'Magepanda', '1972-03-10', '1979-09-09', '< 2 Juta', '< 2 Juta', '81342538169', '81342538169', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '82189800550', 'Bekerja', 'https://drive.google.com/u/0/open?usp=forms_web&id=1X3DPw8IUMtWeUvE7Cvevx2Q_djNn-PQ-', 'https://drive.google.com/u/0/open?usp=forms_web&id=1QVPnGlpn9J9n-OAL_dkhubI6N4qeN4bn', '2021/08/20 10:14:38 AM GMT+7'),
(9, 0, 'CM211', 'Jacob Rapha Tister Nursalim', 'Laki-Laki', '3573052101930000', 'malang', '1993-01-21', 'Kristen', 'Rumah Sendiri', '81231888052', 'jacobnursalim@yahoo.com', 'Jl. Penjaringan palem indah V nirwana regency 660', '', '', '', '', 'S1', 'tiono nursalim', 'Desain Interior', 'Basic', '', '', '', '', '', '', '', '', '', '2021-10-12', '2021-10-12', '', '', '85233344460', '', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '', 'Bekerja', 'https://drive.google.com/u/0/open?usp=forms_web&id=1q74Ias-iqwhp3a2WtQJEhZ5USMdz0UMQ', '', '2021/08/28 7:30:16 PM GMT+7'),
(10, 0, 'CM211', 'Muhammad Dani Fajar Lutfian', 'Laki-Laki', '3578041904030010', 'Malang, Jawa Timur', '2003-04-19', 'Islam', 'Bersama Orang Tua', '81234392003', 'danif2627@gmail.com', 'Perum Grand Harvest cluster Arcadia', '', '', '', '', 'SMA/Sederajat', 'Tipung Saiful Arifudin', 'Editing Video Multimedia', 'Advanced', 'Susi Handayani', '3578042005780000', '3578045609760000', 'Swasta', 'Dosen', '', '', 'Jombang, Jawa Timur', 'Malang, Jawa Timur', '1978-05-20', '1976-09-16', '6 Juta - 10 Juta', '6 Juta - 10 Juta', '81234562117', '81357237676', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '81234392003', 'Sekolah', 'https://drive.google.com/u/0/open?usp=forms_web&id=1AqruoRy3TjDOCev8gtoE2D-IUjdELUKE', 'https://drive.google.com/u/0/open?usp=forms_web&id=165-wQNZGuaqYYDeL_yr0f2BAg2xuPV52', '2021/08/31 3:18:45 PM GMT+7'),
(11, 0, 'CM211', 'yogi rizky wiguna putra', 'Laki-Laki', '3515181410000000', 'surabaya', '2000-10-14', 'Islam', 'Kost-Kostan', '88231179437', 'yogirizky8686@gmail.com', 'manyar sabrangan 1 no 14', '', '', '', '', 'SMA/Sederajat', 'yuto handarusidi', 'Pemrograman Web', 'Basic', '', '3578102702640000', '', 'wirasuasta', '', '', '', 'ampenan', '', '1964-02-27', '2021-10-12', '2 Juta - 5 Juta', '', '817133338', '', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '81335080088', 'tidak berkerja', 'https://drive.google.com/u/0/open?usp=forms_web&id=1Wn_7ReGlK5itTZIjxvoZP3QZaRq-XA1y', 'https://drive.google.com/u/0/open?usp=forms_web&id=1XRT7wlUyIcUUN72gadC978IbbiWL4Y2w', '2021/08/31 5:34:54 PM GMT+7'),
(12, 0, 'CM211', 'Diah Ayu Puspitasari, S.M', 'Perempuan', '3523166404970000', 'Gresik', '1997-04-24', 'Islam', 'Rumah Sendiri', '82136744702', 'diahayupus7@gmail.com', 'Perumahan Pondok Candra, Cluster Emerald, Jalan Delima Timur II No. 2, Waru, Sidoarjo, Jawa Timur.', '', '', '', '', 'S1', 'Zaini', 'Administrasi Perkantoran', 'Advanced', 'Indah Fatmawati', '3523160802680000', '3523164401780000', 'Karyawan BUMN', 'IRT', '', '', 'Lamongan', 'Lamongan', '1968-02-08', '1978-01-04', '> 10 Juta', 'tidak bekerja ', '85649097033', '', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '82136744702', 'Belum bekerja', 'https://drive.google.com/u/0/open?usp=forms_web&id=188pRWK691CcPUvkJpAlS2fGSgDyu6NBo', 'https://drive.google.com/u/0/open?usp=forms_web&id=1jlBOJw9pTR3Ol6Scp8qqtj-S7Ci2qhju', '2021/09/10 2:26:32 PM GMT+7'),
(13, 0, 'CM211', 'Angelina Jesslyn', 'Perempuan', 'B 3711390', 'Surabaya', '2004-10-23', 'Katolik', 'Bersama Orang Tua', '82257787771', 'angelinahartono8@gmail.com', 'Graha Famili T62', '', '', '', '', 'SMA/Sederajat', '', 'Desain Arsitektur', '', '', '', '', '', '', '', '', '', '', '2021-10-12', '2021-10-12', '', '', '', '', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '82257787771', 'Sekolah', 'https://drive.google.com/u/0/open?usp=forms_web&id=1PuM3ccCXBDqBlraMSNYRDHewv4yMQXqi', '', '2021/09/13 8:20:28 PM GMT+7'),
(14, 0, 'CM211', 'Kelvin Kenneth ', 'Laki-Laki', '3578081306940000', 'Jakarta', '1994-06-13', 'Kristen', 'Bersama Orang Tua', '81994199408', 'kelvinkennn@gmail.com', 'Grand Eastwood blok EW 12-9', '', '', '', '', 'Advanced Diploma', '-', 'Desain Interior', 'Advanced', 'Naniek Wibachman', '-', '3578086901660000', '-', 'Wiraswasta', '', '', '-', 'Surabaya', '2021-10-12', '1966-01-29', '-', '-', '-', '816508739', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '', 'Wiraswasta', 'https://drive.google.com/u/0/open?usp=forms_web&id=1mlWTeASmqK7hnp1qTYLK9hT_mjUcCYUS', 'https://drive.google.com/u/0/open?usp=forms_web&id=1KL9KtK3TBaDS-A2HWiX7MmGRmUMxCpw5', '2021/09/14 12:35:00 AM GMT+7'),
(15, 0, 'CM211', 'Eunike Claudia', 'Perempuan', '3578275605030000', 'Surabaya', '2003-05-16', 'Kristen', 'Bersama Orang Tua', '89687416483', '', 'Jl. South Emerald Mansion TK 8 NO. 3, Citraland, Surabaya', '', '', '', '', 'SMA/Sederajat', '', 'Pemrograman Dasar', '', '', '', '', '', '', '', '', '', '', '2021-10-12', '2021-10-12', '', '', '', '', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '', 'Mahasiswa', 'https://drive.google.com/u/0/open?usp=forms_web&id=1NTIm5APVX8LiXUxaWsww3eAnxHPXgZfv', '', '2021/09/15 10:11:46 AM GMT+7'),
(16, 0, 'CM211', 'Shilvinna Maya Reghinna', 'Perempuan', '3525046804020000', 'Gresik', '2002-04-28', 'Islam', 'Bersama Orang Tua', '83831217445', 'shilvinaamayaa@gmail.com', 'Sememi Jaya Selatan 1 Gang Utama RT 10 RW 1 no.12', '', '', '', '', 'SMA/Sederajat', 'Bambang Sutrisno', 'Administrasi Perkantoran', 'Basic', 'Hartatik', '3525041907660000', '3525046001730000', 'Wiraswasta', 'Ibu rumah tangga', '', '', 'Surabaya', 'Gresik', '1966-07-19', '1970-01-20', '800000', '', '83804548012', '83804548012', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '83831217445', 'Wiraswasta', 'https://drive.google.com/u/0/open?usp=forms_web&id=15985rsEQP_Lu_uwVHgIpU2fB5o4hROGL', 'https://drive.google.com/u/0/open?usp=forms_web&id=1hz1-yMarn3LbYyCmYBRJiO7ziQaX3OXf', '2021/09/18 9:06:16 PM GMT+7'),
(17, 0, 'CM211', 'Tsabita Bayu Kandi', 'Perempuan', '3524046105030000', 'Surabaya', '2003-05-20', 'Islam', 'Bersama Orang Tua', '81259605428', 'bayutsabita@gmail.com', 'Perum. Graha Indah Blok C-50 Lamongan', '', '', '', '', 'SMA/Sederajat', 'Bachtiar Febrianto', 'Pemrograman Web', 'Basic', 'Yuli Karnawati', '', '', '', 'PNS', '', '', 'Lamongan', 'Surabaya', '1970-02-11', '1970-07-27', '2 Juta - 5 Juta', '2 Juta - 5 Juta', '6282234091359', '81330133377', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '', 'Gap year (Lulus SMA)', 'https://drive.google.com/u/0/open?usp=forms_web&id=1g30nYw-vuyDOcPb0ZbyOCgI5mjVX7W8P', 'https://drive.google.com/u/0/open?usp=forms_web&id=1Cs688T8j-_1bLAOXs4dcbRD5bHyqGZTN', '2021/09/20 10:37:23 AM GMT+7'),
(18, 0, 'CM211', 'Catherine Pangestu, S.Par', 'Perempuan', '3578256611970000', 'Surabaya', '1997-11-26', 'Budha', 'Bersama Orang Tua', '81222811150', 'Cpangestu261@gmail.com', 'Royal residence b3/45', '', '', '', '', 'S1', 'Praseti pangestu', 'Administrasi Perkantoran', 'Basic', 'Lie hwa ', '-', '-', 'Swasta', 'Ibu rumah tangga', '', '', 'Jambi', 'Surabaya', '1965-11-06', '1970-07-19', '-', '', '81222811150', '', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '-', 'Fresh graduate', 'https://drive.google.com/u/0/open?usp=forms_web&id=1mohWSHowIOJjUJNoF-ZJCgA2MbZBNDJb', 'https://drive.google.com/u/0/open?usp=forms_web&id=1AnejPuYBpwQ1_gg4_NouK3meWhwhIj2E', '2021/09/22 4:34:25 PM GMT+7'),
(19, 0, 'CM211', 'Fanydea Nabilah Alvionita, S.E', 'Perempuan', '3578246503980000', 'Surabaya', '1998-03-25', 'Islam', 'Bersama Orang Tua', '82231205096', 'Fanydea56@gmail.com', 'Omah pesona buduran, Sidoarjo, Jawa timur', '', '', '', '', 'S1', 'Riyang Ali Sodeko', 'Digital Marketing', 'Basic', 'Nur Hayati', '', '', 'Wirausaha', 'Ibu rumah tangga', '', '', 'Lumajang', 'Surabaya', '2021-10-12', '2021-10-12', '', '', '8121771516', '82132191789', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '82231205096', 'Fresh graduate ', 'https://drive.google.com/u/0/open?usp=forms_web&id=1cveSPZMXABLS3TPh0cRwjyATw-iqU9ly', '', '2021/09/28 6:41:18 AM GMT+7'),
(20, 0, 'CM211', 'Cholifa, S.Pd', 'Perempuan', '3578214605980000', 'Surabaya', '1998-05-06', 'Islam', 'Bersama Orang Tua', '85649547717', 'cholifaifa27@gmail.com', 'Jl. Dukuh kalikendal RT.04 RW.02 No.3a ', '', '', '', '', 'S1', 'Dasuki', 'Komputer Umum & Internet', 'Basic', 'Sri Wahyuti', '', '', '', '', '', '', '', '', '2021-10-12', '2021-10-12', '', '', '81331503736', '', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '-', 'Bekerja', 'https://drive.google.com/u/0/open?usp=forms_web&id=1yCSgN-jc67U9rL9cOZHiYVdmKBsEfz67', 'https://drive.google.com/u/0/open?usp=forms_web&id=1QPiGClzTnIlboibxGQoJe23JRB1UONEk', '2021/09/29 11:10:43 AM GMT+7'),
(21, 0, 'CM211', 'Fentie Chrisantyo Tantoso Welliken, S.H., M.Kn.', 'Laki-Laki', '8102012905870000', 'Langgur', '1987-05-29', 'Katolik', 'Kost-Kostan', '81232478777', 'chrisantyo29@gmail.com', 'Tenggilis Mejoyo KB 22', '', '', '', '', 'S2', 'Theresia soenaryo', 'Desain Grafis', 'Basic', '', '', '', '', '', '', '', '', '', '2021-10-12', '2021-10-12', '2 Juta - 5 Juta', '', '81232478777', '', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '81232478777', 'Wiraswasta', 'https://drive.google.com/u/0/open?usp=forms_web&id=1AavBA_ArW_Z7598uKWXp7J-bIU1h_nmk', '', '2021/10/04 10:47:45 AM GMT+7'),
(22, 0, 'CM211', 'Slamet Nurhadi, S. Sos., M.Si.', 'Laki-Laki', '3508101211750000', 'Lumajang', '1975-11-12', 'Islam', 'Bersama Orang Tua', '87750211921', 'candratimur_2010@yahoo.com', 'JL. KAPTEN SUWANDAK RT 002 RW 011 KEL. CITRODIWANGSAN LUMAJANG', '', '', '', '', 'S2', 'BASUNI', 'Digital Marketing', 'custom mandiri class 23 oktober', 'DEWI NARTI', '-', '-', '-', '-', '', '', 'SIDOARJO', 'LUMAJANG', '1946-02-02', '1953-01-01', '2 Juta - 5 Juta', '< 2 Juta', '81249894668', '87750211921', '', '', 'upload/user/avatar.png', '2021-10-12 17:50:52', '2021-10-12 17:50:52', 'aktif', '334892531', 'PNS', 'https://drive.google.com/u/0/open?usp=forms_web&id=1tncTWaz9IYX8T-uJ0d8xWDvZmmaWjG5E', 'https://drive.google.com/u/0/open?usp=forms_web&id=1GOAK_q1rAUqYkhuwRyjVmq5ftSVBINF2', '2021/10/09 7:43:51 AM GMT+7'),
(23, 2, 'CM213', 'tes', 'laki-laki', '', '', '1970-01-01', '', '', '08989', 'tes@gmail.com', 'tes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1970-01-01', '1970-01-01', '', '', '', '', '', '', 'upload/user/avatar.png', '2021-10-18 08:44:27', '2021-10-18 08:44:27', 'calon', '', '', '', '', ''),
(25, 4, 'CM216', 'Coba1', 'laki-laki', '350905', '', '1970-01-01', '', '', '089123456123', 'coba@coba.com', 'jenggawah', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1970-01-01', '1970-01-01', '', '', '', '', '', '', 'upload/user/avatar.png', '2021-10-18 16:05:11', '2021-10-18 16:05:11', 'calon', '', '', '', '', ''),
(26, 5, 'CM217', 'coba2', 'perempuan', '350906', '', '1970-01-01', '', '', '081234567890', 'coba2@coba.com', 'tandes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1970-01-01', '1970-01-01', '', '', '', '', '', '', 'upload/user/avatar.png', '2021-10-18 16:07:24', '2021-10-18 16:07:24', 'calon', '', '', '', '', ''),
(27, 6, 'CM218', 'Coba 3', 'laki-laki', '3509053', '', '1970-01-01', '', '', '08910928991', 'coba3@coba.com', 'Lumajang', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1970-01-01', '1970-01-01', '', '', '', '', '', '', 'upload/user/avatar.png', '2021-10-19 12:14:45', '2021-10-19 12:14:45', 'calon', '', '', '', '', ''),
(28, 7, 'CM219', 'coba4', 'laki-laki', '35090545', '', '1970-01-01', '', '', '08912319109', 'coba4@coba.com', 'Pasuruan', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1970-01-01', '1970-01-01', '', '', '', '', '', '', 'upload/user/avatar.png', '2021-10-19 12:29:23', '2021-10-19 12:29:23', 'calon', '', '', '', '', ''),
(29, 8, 'CM2110', 'coba 5', 'laki-laki', '3409102', '', '1970-01-01', '', '', '09891', 'coba5@coba.com', 'tandes', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '', '1970-01-01', '1970-01-01', '', '', '', '', '', '', 'upload/user/avatar.png', '2021-10-19 12:38:42', '2021-10-19 12:38:42', 'calon', '', '', '', '', '');
...
INSERT INTO `tbl_tentor` (`id_tentor`, `id_login`, `nama_tentor`, `gambar`, `ktp`, `jenis_kelamin`, `tanggal_lahir`, `tempat_lahir`, `alamat`, `kota`, `provinsi`, `telepon`, `telepon_alternatif`, `pendidikan`, `lembaga_pendidikan`, `tahun_lulus`, `tanggal_masuk`, `bidang_studi`, `status_tentor`, `created_date`, `updated_date`) VALUES
(1, 1, 'Pak Dicky', 'upload/gambar/pak_dicky.jpg', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis,Desain 3D Interior,Editing Video Multimedia,Fotografi', 'aktif', '2019-01-23 11:44:06', '2019-02-21 18:00:01'),
(2, 2, 'Pak Richard', 'upload/gambar/Richard-Angkapranoto.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis,Editing Video Multimedia,Fotografi', 'aktif', '2019-01-23 11:48:40', '2019-03-05 08:57:20'),
(3, 3, 'Pak Tjioe Sing Fuk', 'upload/gambar/Tjioe-Sing-fu.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Pemrograman Web,Pemrograman Java Android', 'aktif', '2019-02-12 14:16:00', '2019-02-12 14:16:12'),
(4, 4, 'Pak Sudarmadji', 'upload/gambar/Sudarmadji-Creative-Media.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Pemrograman Web,Pemrograman Java Android', 'aktif', '2019-02-12 14:17:46', '2019-03-14 20:31:56'),
(5, 5, 'Pak Agung Arief Perdana P', 'upload/gambar/Agung-Arief-P.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Pemrograman Web,Pemrograman Java Android', 'aktif', '2019-02-12 14:18:47', '2019-03-14 20:31:39'),
(6, 6, 'Pak Wahyudi', 'upload/gambar/pak_wahyudi.jpg', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain 3D Interior,Desain Arsitektur', 'aktif', '2019-02-12 14:19:33', '2019-03-14 20:32:46'),
(7, 7, 'Pak M. Akbar B.', 'upload/gambar/Akbar-Creative-Media.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis', 'aktif', '2019-02-12 14:19:48', '2019-02-12 14:23:41'),
(8, 8, 'Pak Bagas Grenadega', 'upload/gambar/Bagas-Grenadega.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis,Editing Video Multimedia', 'aktif', '2019-02-12 14:20:29', '2019-02-12 14:23:58'),
(9, 9, 'Bu Siti Munawaroh', 'upload/gambar/bu_siti.jpg', '', 'perempuan', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Administrasi Perkantoran', 'aktif', '2019-02-12 14:21:02', '2019-04-01 15:37:12'),
(10, 10, 'Pak Romi Amirul Hakim', 'upload/gambar/Romi.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Pemrograman Web,Pemrograman Java Android', 'aktif', '2019-02-12 14:21:23', '2019-02-12 14:21:42'),
(11, 11, 'Pak Muh. Hafizh Ardhana ', 'upload/gambar/Hafizh-Creative-Media.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain 3D Interior', 'aktif', '2019-02-12 14:22:13', '2019-02-12 14:24:22'),
(12, 12, 'Bu Rina Andriani', 'upload/gambar/staf_rina.png', '', 'perempuan', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Editing Video Multimedia', 'aktif', '2019-02-12 14:25:44', '2019-02-12 14:26:01'),
(13, 13, 'Pak Arfian Bagus Nurmajis', 'upload/gambar/pak_arfian.jpg', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Pemrograman Web,Pemrograman Java Android', 'aktif', '2019-02-12 14:27:34', '2019-02-12 14:28:45'),
(14, 14, 'Pak Putra Aditya', 'upload/gambar/pak_putra.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain 3D Interior', 'aktif', '2019-02-12 14:28:04', '2019-02-12 14:28:31'),
(15, 15, 'Pak Addin Firdaus Y.', 'upload/gambar/pak_adin.jpg', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Pemrograman Java Android', 'aktif', '2019-02-12 14:28:47', '2019-02-12 14:36:47'),
(16, 16, 'Pak Dyasnata Wirahadi', 'upload/gambar/pak_dyas.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Pemrograman Web', 'aktif', '2019-02-12 14:30:28', '2019-02-12 14:37:12'),
(17, 17, 'Pak Sugianto', 'upload/gambar/pak_sugi.jpg', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis', 'aktif', '2019-02-12 14:31:43', '2019-02-12 14:36:54'),
(18, 18, 'Pak Muhammad Fatoni', 'upload/gambar/staf_fatoni.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Pemrograman Java Android', 'aktif', '2019-02-12 14:32:01', '2019-03-06 14:35:25'),
(19, 19, 'Pak Agus Nanang Arif Efendi', 'upload/gambar/mas_arif.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis,Pemrograman Web,Web Designer', 'aktif', '2019-02-12 14:33:08', '2019-02-12 15:06:49'),
(20, 20, 'Pak Moch. Wahyu Sugiarto', 'upload/gambar/wahyu.jpg', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis,Pemrograman Web,Website Desain CMS,Web Designer', 'aktif', '2019-02-12 14:33:24', '2019-02-12 15:07:17'),
(21, 21, 'Pak Yogi Poedyantoro', 'upload/gambar/Yogi-Poedyantoro.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Pemrograman Web', 'aktif', '2019-02-12 14:35:10', '2019-02-12 14:37:30'),
(22, 22, 'Pak Muhammad Jeffry', 'upload/gambar/M_-jeffry.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis', 'aktif', '2019-02-12 14:40:26', '2019-02-21 18:00:55'),
(23, 23, 'Bu Aisyah', 'upload/gambar/bu_aisyah.png', '', 'perempuan', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Komputer Umum & Internet,Administrasi Perkantoran,Komputer Akuntansi', 'aktif', '2019-03-09 08:59:17', '2019-03-09 09:36:42'),
(24, 24, 'Bu Anggun', 'upload/gambar/bu_anggun.png', '', 'perempuan', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Administrasi Perkantoran,Komputer Akuntansi', 'aktif', '2019-03-09 09:06:07', '2019-03-09 09:37:06'),
(25, 25, 'Bu Septian', 'upload/gambar/bu_septian.png', '', 'perempuan', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Administrasi Perkantoran', 'aktif', '2019-03-09 09:08:11', '2019-03-16 10:08:17'),
(26, 26, 'Pak Frangky', 'upload/gambar/pak_frengky.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Komputer Umum & Internet,Administrasi Perkantoran,Pemrograman Web,Website Desain CMS,Web Designer', 'aktif', '2019-03-09 09:09:52', '2019-03-09 09:19:33'),
(27, 27, 'Bu Tika', 'upload/gambar/bu_tika.png', '', 'perempuan', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis,Editing Video Multimedia,Website Desain CMS', 'aktif', '2019-03-09 09:10:16', '2019-03-09 09:36:25'),
(28, 28, 'Pak Herlambang', 'upload/gambar/pak_herlambang.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Administrasi Perkantoran,Pemrograman Web,Website Desain CMS,Pemrograman Java Android,Web Designer', 'aktif', '2019-03-09 09:11:38', '2019-03-09 09:20:09'),
(29, 29, 'Pak Kurniawan', 'upload/gambar/pak_kurniawan.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Desain Grafis,Editing Video Multimedia,Fotografi', 'aktif', '2019-03-09 09:13:43', '2019-03-09 09:20:35'),
(30, 30, 'Pak Ali', 'upload/gambar/pak_ali.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Website Blog,Administrasi Perkantoran,Desain Grafis,Editing Video Multimedia,Pemrograman Web,Website Desain CMS,Web Designer,Fotografi', 'aktif', '2019-03-09 09:13:54', '2019-03-09 09:21:02'),
(31, 31, 'Pak Tommy', 'upload/gambar/pak_tommy.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Administrasi Perkantoran,Desain Grafis,Editing Video Multimedia,Fotografi', 'aktif', '2019-03-09 09:16:27', '2019-03-09 09:21:20'),
(32, 32, 'Pak Johanes', 'upload/gambar/pak_yohanes.png', '', 'laki-laki', '0000-00-00', '', '', '', '', '', '', '', '', '', '0000-00-00', 'Administrasi Perkantoran,Komputer Akuntansi,Pemrograman Web,Website Desain CMS,Pemrograman Java Android,Web Designer', 'aktif', '2019-03-09 09:18:59', '2019-03-14 20:26:11');
...
--
-- Indexes for table `fasilitas_tipe`
--
...
--
-- Indexes for table `tbl_bidang_studi`
--
...
--
-- Indexes for table `tbl_level_kelas`
--
ALTER TABLE `tbl_level_kelas`
  ADD PRIMARY KEY (`id_level_kelas`);

--
-- Indexes for table `tbl_list_sertifikat`
--
ALTER TABLE `tbl_list_sertifikat`
  ADD PRIMARY KEY (`id_list_sertifikat`);
...
--
ALTER TABLE `bidang_studi`
  MODIFY `id_studi` int(4) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=19;

--
-- AUTO_INCREMENT for table `calon_siswa`
--
ALTER TABLE `calon_siswa`
  MODIFY `id_siswa` int(255) NOT NULL AUTO_INCREMENT;
...
--
-- AUTO_INCREMENT for table `fasilitas_tipe`
--
ALTER TABLE `fasilitas_tipe`
...
--
ALTER TABLE `menu_akses`
  MODIFY `id_menuakses` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4333;
...
--
ALTER TABLE `tbl_bank`
  MODIFY `id_bank` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=136;

--
-- AUTO_INCREMENT for table `tbl_bidang_studi`
--
ALTER TABLE `tbl_bidang_studi`
  MODIFY `id_bidang_studi` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;
...
--
-- AUTO_INCREMENT for table `tbl_level_kelas`
--
ALTER TABLE `tbl_level_kelas`
  MODIFY `id_level_kelas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `tbl_list_sertifikat`
--
ALTER TABLE `tbl_list_sertifikat`
  MODIFY `id_list_sertifikat` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
...
--
ALTER TABLE `tbl_tentor`
  MODIFY `id_tentor` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;
